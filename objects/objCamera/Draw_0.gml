...
draw_clear_alpha(c_black, 1);  // Fully opaque darkness
...
if instance_exists(objPlayer) {
	...
	prevX = lightX;
	prevY = lightY
	var lightScale =  objPlayer.size + 0.1;
draw_sprite_ext(sprLightGradient, 0, lightX, lightY, lightScale, lightScale, 0, c_white, 0.8 + global.power * 0.1);
}
